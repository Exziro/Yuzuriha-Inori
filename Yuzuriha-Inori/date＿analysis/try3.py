# -*- coding: utf-8 -*-
"""
Created on Tue Sep 12 16:04:08 2017
...
train_df = df.filter(regex='Survived|Age_.*|SibSp|Parch|Fare_.*|Cabin_.*|Embarked_.*|Sex_.*|Pclass_.*|Mother|Child|Family|Title')
...
result.to_csv("C:\Users\yixi\Desktop\logistic_regression_predictions.csv", index=False)
